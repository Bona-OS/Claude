...
import { horizonArt, sunsetLights, dayLights, makeGround, makeGrassField, makeWasp, colorMat } from '../world/builders.js';
...
export class Phase09 extends GamePhase {
  ...
  build(ctx) {
    ...
    this.sun = dayLights(scene, { fogNear: 45, fogFar: 300 });
